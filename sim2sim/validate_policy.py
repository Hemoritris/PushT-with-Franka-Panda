...
def main():
    ...
    parser.add_argument("--execute_horizon", type=int, default=6)
    ...
    parser.add_argument("--clamp_action", action=argparse.BooleanOptionalAction, default=True)
    parser.add_argument("--action_ema_alpha", type=float, default=0.30)
    parser.add_argument("--max_action_delta", type=float, default=0.006)
